...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF001F3F);
  late Color secondary = const Color(0xFF969C9B);
  ...
  late Color autobookColour = const Color(0xFF001F3F);
}
