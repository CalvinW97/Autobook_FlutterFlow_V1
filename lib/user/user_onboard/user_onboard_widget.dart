...
import 'user_onboard_model.dart';
export 'user_onboard_model.dart';

class UserOnboardWidget extends StatefulWidget {
  const UserOnboardWidget({super.key});

  static String routeName = 'UserOnboard';
  static String routePath = '/userOnboard';

  @override
  State<UserOnboardWidget> createState() => _UserOnboardWidgetState();
}

class _UserOnboardWidgetState extends State<UserOnboardWidget> {
  late UserOnboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserOnboardModel());
                                            ...
                                            await ProfilesTable().update(
                                              data: {
                                                ...
                                                'postcode': _model
                                                    .postcodeTextFieldTextController
                                                    .text,
                                                'address_line_1': _model
                                                    .address1TextFieldTextController
                                                    .text,
                                                'address_line_2': _model
                                                    .address2TextFieldTextController
                                                    .text,
                                              },
                                              matchingRows: (rows) =>
